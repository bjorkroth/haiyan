...
{
    public class DoorModelElementMapper : IModelElementMapper
    {
        private readonly IfcStore _model;
        private readonly IMaterialBuilder _materialBuilder;

        public DoorModelElementMapper(IfcStore model, IMaterialBuilder materialBuilder)
        {
            _model = model;
